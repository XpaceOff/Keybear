// NOTE:
// I might need to change  lines 40,42 (net)
...
module.exports = {
  ...
  body: p => {
    ...
    function pins(def_neg, def_pos, def_side) {
      ...
      (pad "" np_thru_hole circle (at 1.5 0.33) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
      (pad 1 smd rect (at ${def_neg}2.25 -1.43) (size 0.7 1.5) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) (net 0 ${p.from}))

      (pad 2 smd rect (at ${def_pos}0.75 -1.43) (size 0.7 1.5) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) (net 0 ${p.to}))
